...
<body>
        ...
        <div class="row">
          <div class="col-md-6 ">
            <div class="detail-box">
              <h1>
                Analyste Informaticien <br>
                & <br>
                Développeur web
              </h1>
              <p>
                En tant qu'analyste informaticien et développeur web, je suis passionné par la création de solutions technologiques innovantes, du développement web à l'optimisation des systèmes.<br>
                Mon objectif est de créer des applications performantes et de garantir la sécurité des données pour contribuer à la réussite de votre entreprise.
              </p>
              <a href="#contact">
                Contactez moi
              </a>
    ...
    <div class="container">
      <div class="feature_container">
        <div class="box">
          ...
          <h5 class="name">
          Conception et développement de site ou d applications web  
          </h5>
        </div>
  ...
  <section class="about_section layout_padding-bottom" id="a_propos">
    <div class="container">
      <div class="row">
        <div class="col-lg-5 col-md-6">
          <div class="detail-box">
            ...
            <p>
              Je suis <b>SOSSAVI Patrice analyste informaticien et développeur web</b> passionné par l'innovation technologique. <br>
              Mon expertise en développement web, en analyse informatique et en
              optimisation des systèmes vous garantit des solutions numériques performantes et sur mesure pour votre entreprise
            </p>
        ...
        <div class="col-lg-7 col-md-6">
          <div class="img-box" style="margin: 50px;">
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6 ">
          <div class="detail-box">
            <h2>
              SERVICES ET REALISATIONS <br>
            </h2>
            <p>
              En tant que professionnel de la technologie, je suis déterminé à créer des solutions numériques sur
              mesure, mettant en avant la convivialité, la performance et la sécurité. Mon objectif premier est de donner
              vie à votre vision, que ce soit à travers un site web moderne, une application innovante,
              ou une combinaison des deux, renforçant ainsi votre présence en ligne et stimulant l'engagement de votre public.
            </p>
            <a>
              EN SAVOIR PLUS
            </a>
  ...
  <section class="service_section layout_padding" id="services">
    <div class="container ">
      <div class="heading_container heading_center">
        <h2>Les services que je propose</h2>
      </div>
      <div class="row">
        <div class="col-sm-6 col-md-4 mx-auto">
          <div class="box ">
            ...
            <div class="detail-box">
              ...
              <p>
                Mise en place de sites web et d'applications innovants, axés sur la convivialité et la performance.
              </p>
            </div>
          </div>
        </div>
        <div class="col-sm-6 col-md-4 mx-auto">
          <div class="box ">
            ...
            <div class="detail-box">
              ...
              <p>
                Création de designs créatifs, de logos mémorables et de visuels percutants pour renforcer votre identité visuelle.
              </p>
            </div>
          </div>
        </div>
        <div class="col-sm-6 col-md-4 mx-auto">
          <div class="box ">
            ...
            <div class="detail-box">
              ...
              <p>
                Garantie de la stabilité de vos systèmes, en assurant la sécurité de vos données et la résolution rapide de problèmes techniques.
              </p>
            </div>
          </div>
        </div>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <img src="images/formulaire.jpg" alt="" style="width: 80%;">
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="info_section ">
    ...
    <div class="social-box" id="social-box">
      ...
      <div class="box">
        <a href="https://web.facebook.com/sos.patrice" target="_blank">
          <i class="fa fa-facebook" aria-hidden="true"></i>
        </a>
        <a href="#social-box">
          <i class="fa fa-twitter" aria-hidden="true"></i>
        </a>
        <a href="https://api.whatsapp.com/send?phone=69297288" target="_blank">
  ...
  <footer class="footer_section">
    <div class="container">
      <p>
        &copy; <span id="displayDateYear"></span> PatricePortFolio
      </p>
    </div>
  </footer>
  <!-- footer section -->
